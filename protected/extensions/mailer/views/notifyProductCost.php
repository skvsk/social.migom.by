<html>
    ...
    <body>
        <p>Здравствуйте!</p>
        <p>Спешим Вам сообщить, что <?php echo $date;?> цена на товар <a href="http://migom.by/<?php echo $productId;?>"><?php echo $productName;?></a> снизилась до уровня <?php echo $cost;?>$ или менее.</p>
