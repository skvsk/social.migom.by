...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <div class="row">
		<?php echo $form->labelEx($model->profile,'full_name'); ?>
		<?php echo $form->textField($model->profile,'full_name',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model->profile,'full_name'); ?>
	</div>
